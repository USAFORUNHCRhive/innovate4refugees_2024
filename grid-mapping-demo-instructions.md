...
2) From the main page of the turkana-grid-mapping repository, click the <> Code button, then the Codespaces tab, then select ··· and **New with options**.
...
4) A codespace development environment will open in browser, and will take a few minutes to fully load.
<br />
<br />
...
6) Click **Select Kernel** in the top right of the screen, followed by **Python Environments** and then **venv**, which should be starred.
